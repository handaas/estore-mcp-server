...
@mcp.tool()
def estore_bigdata_global_online_store_profile(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def estore_bigdata_ecommerce_product_profile(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def estore_bigdata_fuzzy_search(matchKeyword: str, pageIndex: int = None, pageSize: int = None) -> dict:
    """
...
@mcp.tool()
def estore_bigdata_ecommerce_store_info(matchKeyword: str, keywordType: str = None) -> dict:
    """
